...
M.cfg = {"wwwroot":"http:\/\/webserver","sesskey":"4xChOuLSJ0","themerev":"1579022437","slasharguments":1,"theme":"boost","iconsystemmodule":"core\/icon_system_fontawesome","jsrev":"1579022437","admin":"admin","svgicons":true,"usertimezone":"Australia\/Perth","contextid":186004,"developerdebug":true,"behatsiterunning":true};var yui1ConfigFn = function(me) {if(/-skin|reset|fonts|grids|base/.test(me.name)){me.type='css';me.path=me.path.replace(/\.js/,'.css');me.path=me.path.replace(/\/yui2-skin/,'/assets/skins/sam/yui2-skin')}};
...
<body  id="page-course-view-topics" class="format-topics  path-course path-course-view dir-ltr lang-en yui-skin-sam yui3-skin-sam webserver pagelayout-course course-187000 context-186004 category-1 behat-site drawer-open-left">
...
//]]>
    ...
    <a id="message-drawer-toggle-5e1f20dc580375e1f20dc566f52" class="nav-link d-inline-block popover-region-toggle position-relative" href="#"
            role="button">
    ...
    id="nav-notification-popover-container" data-userid="453002"
    data-region="popover-region">
    <div class="popover-region-toggle nav-link"
        data-region="popover-region-toggle"
        role="button"
        aria-controls="popover-region-container-5e1f20dc5916f5e1f20dc566f53"
        aria-haspopup="true"
    ...
    <div 
        id="popover-region-container-5e1f20dc5916f5e1f20dc566f53"
        ...
        <a href="http://webserver/message/notificationpreferences.php?userid=453002"
                    ...
                    <div class="dropdown">
                        <a href="#" tabindex="0" class=" dropdown-toggle icon-no-margin" id="dropdown-1" aria-label="User menu" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false" aria-controls="action-menu-1-menu">
                            ...
                            <div class="dropdown-menu dropdown-menu-right menu  align-tr-br" id="action-menu-1-menu" data-rel="menu-content" aria-labelledby="action-menu-toggle-1" role="menu" data-align="tr-br" id="dropdown-menu-1">
                                        ...
                                        <a href="http://webserver/user/profile.php?id=453002" class="dropdown-item menu-action" role="menuitem" data-title="profile,moodle" aria-labelledby="actionmenuaction-2">
                                        ...
                                        <div class="dropdown-divider" role="presentation"><span class="filler">&nbsp;</span></div>
                                        <a href="http://webserver/login/logout.php?sesskey=4xChOuLSJ0" class="dropdown-item menu-action" role="menuitem" data-title="logout,moodle" aria-labelledby="actionmenuaction-6">
    ...
    <div class="col-12 pt-3 pb-3">
        <div class="card ">
            <div class="card-body ">
                <div class="d-flex">
                    <div class="mr-auto">
                        <div class="page-context-header"><div class="page-header-headings"><h1>Science 101</h1></div></div>
                    </div>
...
<i class="icon fa fa-cog fa-fw "  title="Actions menu" aria-label="Actions menu"></i>                                
    ...
    <a href="http://webserver/grade/report/user/index.php?id=187000" id="action_link5e1f20dc566f512" class=""  role="menuitem" ><i class="icon fa fa-area-chart fa-fw "  title="grades" aria-label="grades"></i>Grades</a>
    ...
    <a href="http://webserver/local/qmul_dashboard/index.php" id="action_link5e1f20dc566f513" class=""  role="menuitem" ><i class="icon fa fa-area-chart fa-fw "  title="grades" aria-label="grades"></i>Gradesplus</a>
    ...
    <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item">
                    <a href="http://webserver/course/view.php?id=187000" aria-current="page" title="Science 101">C1</a>
                </li>
    </ol>
</nav>
                    </div>
    ...
    <div
    id="message-drawer-5e1f20dc5d8195e1f20dc566f514"
...
>
    ...
    <div class="body-container position-relative" data-region="body-container">
        ...
        >
        ...
        </div>        <div class="hidden h-100" data-region="view-contacts" aria-hidden="true" data-user-id="453002">
            <div class="d-flex flex-column h-100">
                <div class="p-3 border-bottom">
                    <ul class="nav nav-pills nav-fill" role="tablist">
                        <li class="nav-item">
                            <a
                                id="contacts-tab-5e1f20dc5d8195e1f20dc566f514"
                                class="nav-link active"
                                href="#contacts-tab-panel-5e1f20dc5d8195e1f20dc566f514"
                                data-toggle="tab"
                                data-action="show-contacts-section"
                                role="tab"
                                aria-controls="contacts-tab-panel-5e1f20dc5d8195e1f20dc566f514"
                                aria-selected="true"
                            >
                                Contacts
                            </a>
                        ...
                        <li class="nav-item">
                            <a
                                id="requests-tab-5e1f20dc5d8195e1f20dc566f514"
                                class="nav-link"
                                href="#requests-tab-panel-5e1f20dc5d8195e1f20dc566f514"
                                data-toggle="tab"
                                data-action="show-requests-section"
                                role="tab"
                                aria-controls="requests-tab-panel-5e1f20dc5d8195e1f20dc566f514"
                                aria-selected="false"
                            >
                                Requests
                                <span class="badge bg-primary ml-2 hidden"
            ...
            data-user-id="453002"
                                id="contacts-tab-panel-5e1f20dc5d8195e1f20dc566f514"
                    data-section="contacts"
                    role="tabpanel"
                    aria-labelledby="contacts-tab-5e1f20dc5d8195e1f20dc566f514"
        ...
        >
            ...
            data-region="lazy-load-list"
            data-user-id="453002"
                                id="requests-tab-panel-5e1f20dc5d8195e1f20dc566f514"
                    data-section="requests"
                    role="tabpanel"
                    aria-labelledby="requests-tab-5e1f20dc5d8195e1f20dc566f514"
        ...
        >
            <div
                ...
                style="overflow-y: auto"
            ></div>
        </div>        <div class="h-100 view-overview-body" aria-hidden="false" data-region="view-overview"  data-user-id="453002">
            <div id="message-drawer-view-overview-container-5e1f20dc5d8195e1f20dc566f514" class="d-flex flex-column h-100" style="overflow-y: auto">
                    ...
                    >
                        <div id="view-overview-favourites-toggle" class="card-header p-0" data-region="toggle">
                            <button
                                ...
                                data-target="#view-overview-favourites-target-5e1f20dc5d8195e1f20dc566f514"
                                aria-expanded="false"
                                aria-controls="view-overview-favourites-target-5e1f20dc5d8195e1f20dc566f514"
                            >
                        ...
                        data-region="lazy-load-list"
                        data-user-id="453002"
                                    id="view-overview-favourites-target-5e1f20dc5d8195e1f20dc566f514"
            aria-labelledby="view-overview-favourites-toggle"
            data-parent="#message-drawer-view-overview-container-5e1f20dc5d8195e1f20dc566f514"
                    ...
                    >
                        <div id="view-overview-group-messages-toggle" class="card-header p-0" data-region="toggle">
                            <button
                                class="btn btn-link w-100 text-left p-2 d-flex align-items-center overview-section-toggle collapsed"
                                data-toggle="collapse"
                                data-target="#view-overview-group-messages-target-5e1f20dc5d8195e1f20dc566f514"
                                aria-expanded="false"
                                aria-controls="view-overview-group-messages-target-5e1f20dc5d8195e1f20dc566f514"
                            >
                                <span class="collapsed-icon-container">
                                    <i class="icon fa fa-caret-right fa-fw " aria-hidden="true"  ></i>
                                </span>
                        ...
                        data-region="lazy-load-list"
                        data-user-id="453002"
                                    id="view-overview-group-messages-target-5e1f20dc5d8195e1f20dc566f514"
                    ...
                    >
                        <div id="view-overview-messages-toggle" class="card-header p-0" data-region="toggle">
                            <button
                                class="btn btn-link w-100 text-left p-2 d-flex align-items-center overview-section-toggle collapsed"
                                data-toggle="collapse"
                                data-target="#view-overview-messages-target-5e1f20dc5d8195e1f20dc566f514"
                                aria-expanded="false"
                                aria-controls="view-overview-messages-target-5e1f20dc5d8195e1f20dc566f514"
                            >
                                <span class="collapsed-icon-container">
                                    <i class="icon fa fa-caret-right fa-fw " aria-hidden="true"  ></i>
                                </span>
                        ...
                        data-region="lazy-load-list"
                        data-user-id="453002"
                                    id="view-overview-messages-target-5e1f20dc5d8195e1f20dc566f514"
            ...
            <div class="hidden" data-region="content-container">
                ...
                <div data-region="settings" class="p-3">
                    ...
                    <div data-preference="blocknoncontacts" class="mb-3">
                            <div class="custom-control custom-radio mb-2">
                                <input
                                    ...
                                    id="block-noncontacts-5e1f20dc5d8195e1f20dc566f514-1"
                                    value="1"
                                >
                                <label class="custom-control-label ml-2" for="block-noncontacts-5e1f20dc5d8195e1f20dc566f514-1">
                                    My contacts only
                                </label>
                            </div>
                            <div class="custom-control custom-radio mb-2">
                                <input
                                    ...
                                    name="message_blocknoncontacts"
                                    class="custom-control-input"
                                    id="block-noncontacts-5e1f20dc5d8195e1f20dc566f514-0"
                                    value="0"
                                >
                                <label class="custom-control-label ml-2" for="block-noncontacts-5e1f20dc5d8195e1f20dc566f514-0">
                    ...
                    <div data-preference="entertosend">
                        <span class="switch">
                            <input type="checkbox"
                                id="enter-to-send-5e1f20dc5d8195e1f20dc566f514"
                                checked
                            >
                            <label for="enter-to-send-5e1f20dc5d8195e1f20dc566f514">
                                Use enter to send
                            </label>
                        </span>
                    </div>
    ...
    <footer id="page-footer" class="py-3 bg-dark text-light">
        <div class="container">
            ...
            <div class="logininfo">You are logged in as <a href="http://webserver/user/profile.php?id=453002" title="View profile">Student 1</a> (<a href="http://webserver/login/logout.php?sesskey=4xChOuLSJ0">Log out</a>)</div>
...
function(
    ...
    var toggle = $('#message-drawer-toggle-5e1f20dc580375e1f20dc566f52');
    Popover.init(toggle);
});
;
...
require(['jquery', 'core_message/message_drawer'], function($, MessageDrawer) {
    var root = $('#message-drawer-5e1f20dc5d8195e1f20dc566f514');
    MessageDrawer.init(root, '5e1f20dc5d8195e1f20dc566f514', false);
});
;
...
M.util.help_popups.setup(Y);
 M.util.js_pending('random5e1f20dc566f515'); Y.on('domready', function() { M.util.js_complete("init");  M.util.js_complete('random5e1f20dc566f515'); });
})();
//]]>
</script>
